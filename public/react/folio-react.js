...
function Po({ symbols: e }) {
	let t = e.filter((e) => e.source !== "fallback" && !jo.some((t) => t.symbol === e.symbol)), [n, r] = (0, l.useState)(""), [i, a] = (0, l.useState)(""), [o, s] = (0, l.useState)(jo[0].symbol), [c, u] = (0, l.useState)("3m"), [d, f] = (0, l.useState)("line"), [p, m] = (0, l.useState)(null), [h, g] = (0, l.useState)(null), [_, v] = (0, l.useState)(""), y = (0, l.useRef)(null), b = (0, l.useRef)(!1);
	async function x(e) {
	...
	(0, l.useEffect)(() => {
		...
		jo.some((e) => e.symbol === o) || t.some((e) => e.symbol === o) || s(jo[0].symbol);
	}, [t, o]);
	function w(e) {
	...
	let k = p?.series || [], A = k.length ? k[k.length - 1].close : null, j = p?.interval === "5m", M = k.length > 1 ? j ? k[0].close : k[k.length - 2].close : null, N = A != null && M ? (A - M) / M * 100 : null, P = To[p?.freshness || ""] || (p ? p.freshness : "불러오는 중");
	return /* @__PURE__ */ (0, K.jsxs)("section", {
				...
				children: [/* @__PURE__ */ (0, K.jsxs)("div", { children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "MARKET CHART" }), /* @__PURE__ */ (0, K.jsx)("h2", {
					...
					children: [/* @__PURE__ */ (0, K.jsxs)("details", {
						...
						children: [/* @__PURE__ */ (0, K.jsx)("summary", { children: "지수" }), /* @__PURE__ */ (0, K.jsx)("div", {
							...
							children: jo.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
								type: "button",
				...
				children: [/* @__PURE__ */ (0, K.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, K.jsx)("span", {
							...
							children: jo.find((e) => e.symbol === o)?.label || o
						}),
						/* @__PURE__ */ (0, K.jsxs)("div", {
			...
			h && /* @__PURE__ */ (0, K.jsxs)("p", {
				...
				children: [
					/* @__PURE__ */ (0, K.jsx)("span", {
						...
						children: io[h.status] || h.status
					}),
					"다음 일정 — ",
					/* @__PURE__ */ (0, K.jsx)("b", { children: No(h) }),
...
function Uo(e) {
	let t = Ro(e), n = Ro(t?.marketStateRef) || Ro(Ro(t?.marketStateResolution)?.ref) || Ro(t?.ref);
	if (!n || !Lo.includes(n.status) || [
		"snapshotId",
		"sourceKind",
		"scope",
		"asOf",
	...
	if (![
		...
		"US",
		"KR"
	].includes(i) || n.layer !== "source-grounded" || !Bo(n.resolvedAt) || !Number.isInteger(n.invalidWatermarkRows) || Number(n.invalidWatermarkRows) < 0 || n.inputWatermark !== null && typeof n.inputWatermark != "string" || n.relevantEvidenceWatermark !== null && typeof n.relevantEvidenceWatermark != "string" || n.relevantEvidenceWatermark !== null && !Bo(n.relevantEvidenceWatermark)) return null;
	let a = n.status, o = n.freshnessReason;
	return typeof o != "string" || a === "current" && (r !== "snapshot" || typeof n.snapshotId != "string" || !n.snapshotId || !Vo(n.asOf) || o !== "within_window") || a === "current" && n.inputWatermark !== null && !Bo(n.inputWatermark) || a === "current" && n.inputWatermark === null != (n.relevantEvidenceWatermark === null) || a === "stale" && (r !== "snapshot" || typeof n.snapshotId != "string" || !n.snapshotId || !Ho.has(o)) || a === "stale" && o !== "invalid_as_of" && !Vo(n.asOf) || a === "fallback" && (r !== "state_fallback" || n.snapshotId !== null || n.asOf !== null && !Vo(n.asOf) || o !== "state_fallback" || n.inputWatermark !== null) || a === "empty" && (r !== "none" || n.snapshotId !== null || n.asOf !== null || o !== "no_state" || n.inputWatermark !== null || n.relevantEvidenceWatermark !== null) ? null : {
...
function qo(e) {
	return {
		...
		market: e.market,
		sources: Ko(e.sources),
		tickers: Ko(e.tickers, !0),
		tags: Ko(e.tags)
	};
}
function Jo(e) {
...
function Yo({ mode: e, revision: t, draft: n, busy: r, onChange: i, onCancel: a, onSave: o }) {
	return /* @__PURE__ */ (0, K.jsxs)("div", {
...
function ts({ selectedRef: e, onSelectedRef: t, onBusyChange: n, onOpenDetail: r, disabled: i }) {
	let [a, o] = (0, l.useState)([]), [s, c] = (0, l.useState)(0), [u, d] = (0, l.useState)(!0), [f, p] = (0, l.useState)(null), [m, h] = (0, l.useState)(""), [g, _] = (0, l.useState)(null), [v, y] = (0, l.useState)(Go), [b, x] = (0, l.useState)(null), [S, C] = (0, l.useState)(!1), [w, T] = (0, l.useState)(!1), [E, D] = (0, l.useState)(""), [O, k] = (0, l.useState)(null), A = (0, l.useRef)(0), j = (0, l.useRef)(0), M = (0, l.useRef)(null), N = (0, l.useRef)(null);
	function P(e, t) {
		y((n) => ({
			...n,
			[e]: t
	...
	let z = () => {
		p("create"), h(""), _(null), y(Go), k(null), D("");
	}, H = () => {
		I && (p("edit"), h(I.id), _(I.revision), y(Jo(I)), k(null), D(""));
	}, U = async () => {
		let e = qo(v);
		...
		try {
			...
			e instanceof F && e.status === 409 && (e.code === "revision_conflict" || e.code === "duplicate_name") ? (k({
				code: e.code,
				currentRevision: Qo(e)
			}), e.code === "revision_conflict" && t(null)) : D(Zo(e));
		} finally {
			T(!1);
		}
	}, ee = async () => {
						...
						/* @__PURE__ */ (0, K.jsxs)("div", {
							...
							children: [!u && !E && !a.length && /* @__PURE__ */ (0, K.jsx)("div", {
								...
								return /* @__PURE__ */ (0, K.jsxs)("button", {
									...
									disabled: w || i,
									onClick: () => void R(t),
									children: [/* @__PURE__ */ (0, K.jsxs)("span", { children: [/* @__PURE__ */ (0, K.jsx)("strong", { children: t.name }), /* @__PURE__ */ (0, K.jsxs)("small", { children: ["버전 ", t.revision] })] }), /* @__PURE__ */ (0, K.jsx)("small", { children: Xo(t) })]
								}, t.id);
							})]
						}),
...
function ns({ collectionId: e, onBack: t, onStartResearch: n }) {
	let [r, i] = (0, l.useState)(null), [a, o] = (0, l.useState)(null), [s, c] = (0, l.useState)(!0), [u, d] = (0, l.useState)(!1), [f, p] = (0, l.useState)(null), [m, h] = (0, l.useState)(""), g = (0, l.useRef)(null), _ = (0, l.useCallback)(async ({ preserveMessage: t = !1 } = {}) => {
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError") return;
			e instanceof F && e.code === "collection_not_found" ? p("deleted") : e instanceof F && e.code === "collection_source_unavailable" ? p("source") : p("other"), h(Zo(e));
		} finally {
	...
	let v = async () => {
		...
		try {
			...
			e instanceof F && e.status === 409 ? (h("다른 탭에서 정의가 변경되었습니다. 최신 revision을 다시 불러왔습니다."), await _({ preserveMessage: !0 })) : e instanceof F && e.code === "collection_not_found" ? (p("deleted"), h(Zo(e))) : (e instanceof F && e.code === "collection_source_unavailable" && p("source"), h(Zo(e)));
		} finally {
			d(!1);
		}
	}, y = () => {
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, K.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, K.jsx)("small", { children: r.healthReasonCodes.map(es).join(" · ") })
					] }),
					/* @__PURE__ */ (0, K.jsxs)("div", { children: [
						/* @__PURE__ */ (0, K.jsx)("span", { children: "마지막 새로고침" }),
						/* @__PURE__ */ (0, K.jsx)("strong", { children: $o(r.lastRefresh) }),
					...
					children: [
						/* @__PURE__ */ (0, K.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)("strong", {
								...
								children: "스냅샷 변경"
							}), /* @__PURE__ */ (0, K.jsx)("span", { children: a?.observedAt ? $o(a.observedAt) : "확인 전" })]
						}),
				...
				children: [
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, K.jsx)("h3", {
							...
							ks(t.researchQuestions),
							/* @__PURE__ */ (0, K.jsx)("h4", { children: "반증 조건" }),
							ks(t.falsificationTriggers)
						] }) : /* @__PURE__ */ (0, K.jsx)(is, {})]
					}),
					/* @__PURE__ */ (0, K.jsxs)("section", {
						className: "topicrpt-provenance-panel",
						...
						children: [/* @__PURE__ */ (0, K.jsx)("h3", {
							...
							}) : /* @__PURE__ */ (0, K.jsx)(is, { children: "분석 축별 커버리지가 없습니다." }),
					...
					/* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [
							...
							}) : /* @__PURE__ */ (0, K.jsx)(is, { children: "확인 가능한 외부 근거 원장이 없습니다." })
						]
					}),
					/* @__PURE__ */ (0, K.jsxs)("section", {
						className: "topicrpt-provenance-panel",
						...
						}) : /* @__PURE__ */ (0, K.jsx)(is, { children: "기록된 자료 공백이 없습니다." })]
					}),
					/* @__PURE__ */ (0, K.jsxs)("section", {
						className: "topicrpt-provenance-panel",
						"data-qa": "dr-quality",
						...
						children: [/* @__PURE__ */ (0, K.jsx)("h3", {
							...
							ks(e.quality.warnings, "경고 없음"),
							/* @__PURE__ */ (0, K.jsx)("h4", { children: "보완 제안" }),
							ks(e.quality.suggestedFixes, "제안 없음")
						] }) : /* @__PURE__ */ (0, K.jsx)(is, {})]
					}),
					/* @__PURE__ */ (0, K.jsxs)("section", {
						className: "topicrpt-provenance-panel topicrpt-provenance-wide",
...
var ss = "custom", cs = { custom: "직접 질문" }, ls = [
	"queued",
	"running",
	"cancel_requested",
	"committing",
...
function ps(e) {
	return ds(e) ? typeof e.id == "string" && fs(e.status) : !1;
}
function ms(e) {
	return ds(e) ? ps(e.job) : !1;
}
...
async function gs(e, t) {
	...
	for (; I(n.status);) {
		...
		await us(1e3, t), n = await B(`/api/jobs/${encodeURIComponent(n.id)}`, { signal: t });
	}
	if (n.status !== "done") throw new hs(n);
	return n;
}
function _s(e = "", t = "딥 리서치") {
	let n = e.replace(/\r\n/g, "\n").split("\n"), r = n.findIndex((e) => e.trim());
	if (r < 0) return {
		title: t,
		body: ""
...
function ys(e) {
	...
	return cs[t] ? cs[t] : String(e.topicLabel || "").trim() || (t ? t.replace(/_/g, " ") : "기타");
}
function bs(e) {
	return pn(e) || "날짜 미상";
}
...
function Es(e) {
	return e instanceof F ? e.code : e instanceof hs ? e.job.errorCode || e.job.status : e instanceof Error ? e.name : "request_failed";
}
function Ds(e, t) {
	let n = Es(t);
...
function js({ busy: e, onSubmit: t, onCancel: n }) {
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsx)("div", {
				...
				children: As.map((t) => /* @__PURE__ */ (0, K.jsx)("button", {
					className: "chip",
					type: "button",
					disabled: e,
					onClick: () => i(t),
...
function Ms({ envelope: e, onContinue: t, onEdit: n, degradedConfirming: r, onConfirmDegraded: i, onCancelDegraded: a, editing: o, revising: s, replanning: c, onReplan: l, onEditPlan: u, onRevise: d, onCancelEdit: f }) {
					...
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [
							...
							h.analysisAxes.length ? /* @__PURE__ */ (0, K.jsx)("ul", {
								...
								children: h.analysisAxes.map((e) => /* @__PURE__ */ (0, K.jsxs)("li", { children: [/* @__PURE__ */ (0, K.jsx)("strong", { children: e.label }), ks(e.questions)] }, e.key))
							}) : /* @__PURE__ */ (0, K.jsx)("span", {
								className: "topicrpt-empty-value",
								children: "분석 축 없음"
							})
...
function Ns() {
	let e = dn("topicReport"), [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)(null), a = (0, l.useMemo)(() => $n(window.location.hash), []), [o, s] = (0, l.useState)(a.kind === "report" ? a.id : ""), [c, u] = (0, l.useState)(a.kind === "collection" ? a.id : ""), [d, f] = (0, l.useState)(a.malformed), [m, h] = (0, l.useState)(""), [g, _] = (0, l.useState)(""), [v, y] = (0, l.useState)("include_current"), [b, x] = (0, l.useState)("AUTO"), [S, C] = (0, l.useState)(null), [w, T] = (0, l.useState)(!1), [E, D] = (0, l.useState)("readiness"), [O, k] = (0, l.useState)(null), [A, j] = (0, l.useState)(!1), [M, N] = (0, l.useState)(!1), [P, I] = (0, l.useState)(""), [L, R] = (0, l.useState)(null), [z, H] = (0, l.useState)(""), [U, ee] = (0, l.useState)(null), [te, W] = (0, l.useState)(""), [G, q] = (0, l.useState)(""), [ne, re] = (0, l.useState)(0), [ie, ae] = (0, l.useState)("auto"), [oe, ce] = (0, l.useState)(!1), [le, ue] = (0, l.useState)(!1), [de, fe] = (0, l.useState)(!1), [pe, me] = (0, l.useState)(""), [he, ge] = (0, l.useState)("recent"), _e = (0, l.useRef)(0), ve = (0, l.useRef)(null), ye = (0, l.useRef)(null), be = (0, l.useRef)(""), xe = (0, l.useRef)(!1), Se = ss, Ce = m, we = (0, l.useCallback)(() => {
		ve.current?.abort();
		let e = new AbortController();
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError") return;
			I(Ds("readiness", e)), R("readiness"), H(Es(e));
			let t = Es(e);
	...
	(0, l.useEffect)(() => {
		...
		async function n(n) {
			...
			try {
				...
				i(null), I(Ds("report", n)), R("report"), H(Es(n)), D("recoverable-error");
			} finally {
	...
	let Oe = async (e) => {
		...
		try {
			...
			I(Ds("plan", e)), R("plan"), H(Es(e)), ee(Es(e) === "no_index" || Es(e) === "index_unavailable" ? "no-index" : Es(e) === "rss_unavailable" ? "rss" : null), D("recoverable-error"), W("");
		}
	}, ke = async (e) => {
		let t = we();
		...
		try {
			let e = await V("/api/topic-reports", a, { signal: t.signal }), r = ms(e) ? e.job : ps(e) ? e : null;
			if (!r) throw Error("생성 작업 ID를 확인하지 못했습니다.");
			let o = await gs(r, t.signal);
			if (!Te(t.id)) return;
			...
			if (!Te(t.id)) return;
			n((e) => [c, ...e.filter((e) => e.id !== c.id)]), i(c), D("report"), W("딥 리서치를 생성하고 자동 저장했습니다."), ws(c.id), J("deep-research", {
				surface: "topic_report_reader",
				viewId: "topicrpt",
				reportKind: "topic_report",
				reportId: c.id || "",
			...
			I(Ds("generation", e)), R(e instanceof F && (e.code === "evidence_confirmation_required" || e.code === "resolution_changed") ? "degraded" : "generation"), H(Es(e)), D("recoverable-error"), W("");
		}
	}, Ae = () => {
		if (O) {
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError" || !Te(t.id)) return;
			I(Ds("plan", e)), R("plan"), H(Es(e)), D("recoverable-error"), W("");
		} finally {
			Te(t.id) && (fe(!1), ue(!1));
		}
	}, Me = async (e) => {
		...
		try {
			...
			if (e instanceof DOMException && e.name === "AbortError" || !Te(t.id)) return;
			I(Ds("degraded", e)), R("degraded"), H(Es(e)), D("recoverable-error"), W("");
		}
	};
	async function Pe(e) {
		if (!(!e.id || !window.confirm(`${vs(e)} 보고서를 삭제할까요?`))) {
			q(`delete-${e.id}`), I("");
			try {
				...
				I(e instanceof Error ? e.message : "보고서 삭제에 실패했습니다."), R("report"), H(Es(e));
			} finally {
				q("");
			}
		}
	...
	async function Ie() {
		if (r?.id) {
			...
			try {
				...
				ps(e) && await gs(e, new AbortController().signal);
	...
	let Le = (0, l.useMemo)(() => {
		...
		if (he === "recent") return t.length ? [{
			key: `최근 리서치 ${Math.min(t.length, Cs)}건`,
			rows: t.slice(0, Cs)
		}] : [];
		let n = /* @__PURE__ */ new Map();
		for (let e of t) {
			let t = he === "month" ? xs(e.generatedAt || e.date) : ys(e);
	...
	}, [Le, he]), Be = _s(r?.markdown || "", r ? vs(r) : "딥 리서치"), Ve = Wo(r?.marketStateResolution), He = (0, l.useCallback)((e) => {
	...
	if (r && E === "report") return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsxs)(Jn, {
				...
				title: Be.title,
				meta: `${vs(r)} · 뉴스 ${r.docCount || 0}건 · 내러티브 ${r.memoryCount || 0}건`,
				agentContext: {
					surface: "topic_report_reader",
					viewId: "topicrpt",
					reportKind: "topic_report",
				...
				noteIdentity: {
					...
					title: vs(r) ? `${vs(r)} 리서치 노트` : "딥 리서치 노트",
					topic: vs(r),
					label: vs(r),
					reportKind: "topic_report",
					reportId: vs(r),
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			...
			E === "plan-review" && O && /* @__PURE__ */ (0, K.jsx)(Ms, {
				envelope: O,
				onContinue: Ae,
				onEdit: () => {
					D("draft"), ce(!1), W("");
							...
							return /* @__PURE__ */ (0, K.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, K.jsxs)("button", {
									...
									children: [
										...
										/* @__PURE__ */ (0, K.jsx)("strong", { children: vs(e) }),
										/* @__PURE__ */ (0, K.jsxs)("span", {
											className: "report-feed-card-foot",
...
function Rs(e) {
	let t = String(e || "").replace(/\s+/g, " ").trim(), n = Ls(t);
	return {
		lead: n[0] || t,
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("h3", { children: e.title }), /* @__PURE__ */ (0, K.jsx)("div", {
					...
					children: e.directionLabel && /* @__PURE__ */ (0, K.jsx)("span", {
						className: `market-direction-chip direction-${Bs(e)}`,
						children: Vs(e)
					})
				})]
			}),
...
function Ys({ stateRef: e }) {
	let t = e?.freshnessReason === "age_exceeded" ? "만료" : e ? Gs[e.status] : "확인 불가";
	return /* @__PURE__ */ (0, K.jsxs)("dl", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("dt", { children: "기준 시각" }), /* @__PURE__ */ (0, K.jsx)("dd", { children: zs(e?.asOf || void 0) || "없음" })]
			}),
			/* @__PURE__ */ (0, K.jsxs)("div", { children: [/* @__PURE__ */ (0, K.jsx)("dt", { children: "경과" }), /* @__PURE__ */ (0, K.jsx)("dd", { children: Js(e) })] }),
			/* @__PURE__ */ (0, K.jsxs)("div", {
				"data-qa": "market-state-source",
				children: [/* @__PURE__ */ (0, K.jsx)("dt", { children: "출처" }), /* @__PURE__ */ (0, K.jsx)("dd", { children: e ? Ks[e.sourceKind] : "응답 검증 실패" })]
			}),
...
function Xs({ stateRef: e }) {
	let t = e.freshnessReason === "age_exceeded", n = e.freshnessReason === "new_relevant_evidence" ? "새 외부 자료가 들어왔습니다." : qs[e.freshnessReason] || "최신성을 다시 확인해야 합니다.", r = e.freshnessReason === "new_relevant_evidence" ? zs(e.relevantEvidenceWatermark || void 0) : "";
	return /* @__PURE__ */ (0, K.jsxs)("div", {
...
function Zs({ state: e, stateRef: t, error: n, drivers: r }) {
	let i = e === "fallback" ? "참고용 내러티브만 있습니다" : "아직 생성된 시장 상태가 없습니다", a = n ? `시장 상태 응답을 사용할 수 없습니다: ${n}` : qs[t?.freshnessReason || ""] || "현재 상태를 검증할 수 없습니다. 업데이트 후 다시 확인하세요.";
	return /* @__PURE__ */ (0, K.jsxs)("section", {
		className: `market-state-gap state-${e}`,
		role: "status",
		children: [
			/* @__PURE__ */ (0, K.jsx)("span", { children: Gs[e] }),
...
function Qs({ payload: e, selectedMarket: t = "overall", loading: n = !1, updating: r = !1, updateDisabled: i = !1, error: a = "", onSelectMarket: o, onUpdate: s, onReload: c }) {
	let l = Uo(e), u = l?.status || "empty", d = e?.marketViews || {}, { isSelected: f } = _n(), p = Fs.filter((e) => e === "overall" || !!d[e] && f(e)), m = p.includes(t) ? t : "overall", h = m === "overall" ? d.overall || e : d[m] || e, g = h?.drivers ?? [], _ = h?.plainConclusion || h?.summary || "", v = h?.reasonSummary || h?.sourceSummary || h?.stance || "", y = Rs(v), b = u === "current" || u === "stale", x = h?.briefs?.length ? h.briefs : [
		{
			label: "현재 판단",
			value: _
		},
	...
	return /* @__PURE__ */ (0, K.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsx)(Ys, { stateRef: l }),
			u === "stale" && l ? /* @__PURE__ */ (0, K.jsx)(Xs, { stateRef: l }) : null,
			...
			b ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
				u === "current" ? /* @__PURE__ */ (0, K.jsx)("p", {
					...
					children: qs[l?.freshnessReason || "within_window"]
				}) : null,
				/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				/* @__PURE__ */ (0, K.jsx)("div", {
					...
					children: g.map((e, t) => /* @__PURE__ */ (0, K.jsx)(Ws, { driver: e }, e.id || t))
				}),
				h && ((h.counterEvidence?.length || 0) > 0 || (h.uncertainties?.length || 0) > 0) ? /* @__PURE__ */ (0, K.jsxs)("div", {
					...
					children: [h.counterEvidence?.length ? /* @__PURE__ */ (0, K.jsxs)("section", {
						...
						children: [/* @__PURE__ */ (0, K.jsx)("h3", { children: "반대 근거" }), /* @__PURE__ */ (0, K.jsx)(Us, { items: h.counterEvidence })]
					}) : null, h.uncertainties?.length ? /* @__PURE__ */ (0, K.jsxs)("section", {
						"data-qa": "market-state-uncertainties",
						children: [/* @__PURE__ */ (0, K.jsx)("h3", { children: "불확실성" }), /* @__PURE__ */ (0, K.jsx)(Us, { items: h.uncertainties })]
					}) : null]
				}) : null,
...
function $s({ onUpdate: e, updating: t = !1, updateDisabled: n = !1, onContext: r } = {}) {
...
var ec = "folio.marketMemory.activeJob.v1", tc = /^job_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/, nc = /* @__PURE__ */ new Set([
	"queued",
	"running",
	"cancel_requested",
	"committing",
	...
	"failed_restart",
	"failed_commit_recovery"
]), rc = "market_memory_update", ic = "LLM CLI 시장 메모리 업데이트";
function ac() {
	try {
...
function sc(e, t) {
	...
	let n = e;
	return n.id === t && nc.has(n.status);
}
function cc(e) {
	if (!e || typeof e != "object" || Array.isArray(e)) return !1;
	let t = e;
	return !oc(t.id) || !nc.has(t.status) || !I(t.status) ? !1 : t.taskType === rc || t.taskType === void 0 && t.label === ic;
}
function lc(e = ac()) {
	try {
		e?.removeItem(ec);
...
function uc(e = ac()) {
	...
	return t ? oc(t) ? t : (lc(e), null) : null;
}
function dc(e, t = ac()) {
	if (!oc(e) || !t) return !1;
	try {
		return t.setItem(ec, e), t.getItem(ec) === e;
	} catch {
		return !1;
	}
}
async function fc(e, t = ac()) {
	let n = uc(t);
...
async function _c() {
	return V("/api/memory/update", { date: mc() });
}
function vc() {
	...
	function m(e) {
		...
		lc(), o(`시장 메모리를 업데이트했습니다. ${hc(e)}`), d(null), t((e) => e + 1);
	}
	(0, l.useEffect)(() => {
		let e = !0;
		return (async () => {
			let t = await fc((e) => B(`/api/jobs/${encodeURIComponent(e)}`));
			if (t.kind === "none" && (t = await pc(() => B("/api/jobs"))), e) if (t.kind === "active") {
				d(t.job), i(!0), o("이전에 시작한 서버 작업에 자동으로 다시 연결했습니다.");
				try {
					await h(t.job);
				} catch (t) {
					if (!e) return;
					t instanceof at ? (lc(), d(null), c(t.message), o("")) : t instanceof DOMException && t.name === "AbortError" || (c(t instanceof Error ? t.message : "작업 상태 확인에 실패했습니다."), o(""));
				} finally {
					e && i(!1);
				}
	...
	async function g() {
		...
		try {
			...
			let e = await _c();
			gc(e) ? (dc(e.id), d(e), await h(e)) : m(e);
		} catch (e) {
			e instanceof at ? (lc(), d(null), c(e.message), o("")) : e instanceof DOMException && e.name === "AbortError" || (c(e instanceof Error ? e.message : "시장 메모리 업데이트에 실패했습니다."), o(""));
		} finally {
			i(!1);
		}
	}
	async function _() {
		if (u) {
			...
			try {
				...
				e instanceof at ? (lc(), d(null), c(e.message), o("")) : e instanceof DOMException && e.name === "AbortError" || (c(e instanceof Error ? e.message : "작업 상태 확인에 실패했습니다."), o(""));
			} finally {
				i(!1);
			}
		}
...
function yc({ positions: e, onChange: t }) {
				...
				children: [
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, K.jsxs)("span", { children: [
							...
							d,
							" 환산)"
						] }), /* @__PURE__ */ (0, K.jsx)("strong", { children: Cc(u.totalMarketValue) })]
					}),
					/* @__PURE__ */ (0, K.jsxs)("div", {
						className: "portfolio-metric",
						children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "원금" }), /* @__PURE__ */ (0, K.jsx)("strong", { children: Cc(u.totalCost) })]
					}),
					/* @__PURE__ */ (0, K.jsxs)("div", {
						className: "portfolio-metric",
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsx)("strong", { children: Cc(u.totalPnl) }),
					...
					/* @__PURE__ */ (0, K.jsxs)("table", {
						...
						children: [/* @__PURE__ */ (0, K.jsx)("thead", { children: /* @__PURE__ */ (0, K.jsxs)("tr", { children: [
							...
							return /* @__PURE__ */ (0, K.jsxs)("tr", { children: [
								...
								/* @__PURE__ */ (0, K.jsx)("td", { children: Cc(e.marketValue) }),
								...
								/* @__PURE__ */ (0, K.jsx)("td", { children: n ? Cc(n.amount) : "—" })
							] }, e.currency);
						}) })]
					}),
					/* @__PURE__ */ (0, K.jsxs)("p", {
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, K.jsx)("h3", { children: "구성" }), /* @__PURE__ */ (0, K.jsx)("div", {
						...
						role: "group",
						"aria-label": "구성 기준",
						children: Ec.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
							type: "button",
				...
				}), /* @__PURE__ */ (0, K.jsx)(Dc, { slices: u[r] })]
			}),
			/* @__PURE__ */ (0, K.jsxs)("div", {
				className: "portfolio-block",
...
function jc({ series: e, benchmark: t }) {
...
function Ic(e, t) {
	return e === null ? "—" : t === "pct" ? wc(e) : Cc(e, 2);
}
function Lc(e, t) {
	return e.presetName || e.name || `프리셋 ${t + 1}`;
}
function Rc(e, t, n) {
	let r = e.map((e) => Fc(e, t)), i = r.filter((e) => e !== null);
...
function Bc({ results: e }) {
	...
	return /* @__PURE__ */ (0, K.jsx)("svg", {
		...
		children: t.map((e, t) => /* @__PURE__ */ (0, K.jsx)("path", {
			"data-tone": Pc[t % Pc.length],
			className: "portfolio-compare-line",
			d: zc(e.series, i, 640, 180)
		}, e.presetId || e.name || t))
	});
}
var Vc = [
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, K.jsx)("span", {
							...
							children: Vc.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
								type: "button",
								"aria-pressed": a === e.id,
								onClick: () => o(e.id),
								children: e.label
			...
			u && /* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, K.jsx)(Bc, { results: u.results }),
					/* @__PURE__ */ (0, K.jsx)("ul", {
					...
					/* @__PURE__ */ (0, K.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, K.jsxs)("table", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)("thead", { children: /* @__PURE__ */ (0, K.jsxs)("tr", { children: [/* @__PURE__ */ (0, K.jsx)("th", {
								...
								scope: "col",
								children: Lc(e, t)
							}, e.presetId || e.name || t))] }) }), /* @__PURE__ */ (0, K.jsx)("tbody", { children: Nc.map((e) => {
								let t = Rc(u.results, e.key, e.better);
								return /* @__PURE__ */ (0, K.jsxs)("tr", { children: [/* @__PURE__ */ (0, K.jsx)("th", {
									...
									return /* @__PURE__ */ (0, K.jsx)("td", {
										...
										"data-sign": e.kind === "pct" && i !== null ? Tc(i) : void 0,
										children: Ic(i, e.kind)
									}, n.presetId || n.name || r);
								})] }, e.key);
							}) })]
						})
	...
	return /* @__PURE__ */ (0, K.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsx)("div", {
				...
				role: "group",
				"aria-label": "포트폴리오 보기",
				children: Wc.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
					type: "button",
					"aria-pressed": i === e.id,
					onClick: () => a(e.id),
					children: e.label
			...
			i === "holdings" && /* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsxs)("section", {
					...
					children: [
						...
						/* @__PURE__ */ (0, K.jsx)(xc, { tickers: n.map((e) => e.ticker).filter(Boolean) }),
			...
			i === "backtest" && /* @__PURE__ */ (0, K.jsxs)("section", {
				...
				}), /* @__PURE__ */ (0, K.jsx)(Mc, { revision: h })]
			})
		]
	});
}
...
function qc(e) {
	...
	let t = Kc[e.kind] || e.kind, n = e.tickers && e.tickers[0] || e.id || "";
	return n ? `${n}` : t;
}
function Jc(e) {
	if (!e) return "";
...
function Yc({ activeId: e, refreshKey: t, onSelect: n, onDeleted: r }) {
...
var Xc = "folio.agentThreads.migrated.v1";
function Zc(e, t) {
	return {
		id: e.id || `restored-${t}`,
...
function Qc(e) {
	let [t, n] = (0, l.useState)(""), [r, i] = (0, l.useState)(null), [a, o] = (0, l.useState)(0), [s, c] = (0, l.useState)(null), u = (0, l.useRef)(!1), d = (0, l.useCallback)(() => o((e) => e + 1), []), f = (0, l.useCallback)(async (e = {}) => {
		...
		let a = r.messages || [];
		return a.length ? a.map(Zc) : [{
			...e,
			createdAt: (/* @__PURE__ */ new Date()).toISOString()
		}];
	}, [e]), m = (0, l.useCallback)(async () => {
		if (u.current || (u.current = !0, window.localStorage.getItem(Xc))) return;
		let e = bt().filter((e) => e.text && !pt(e));
		if (!e.length) {
			window.localStorage.setItem(Xc, (/* @__PURE__ */ new Date()).toISOString());
			return;
		}
		try {
			let t = await V("/api/agent/threads", {
			...
			window.localStorage.setItem(Xc, (/* @__PURE__ */ new Date()).toISOString()), St(), window.localStorage.removeItem(dt), d();
		} catch {
			u.current = !1;
		}
...
var $c = /* @__PURE__ */ new Set([
	...
	variant: "welcome",
	createdAt: (/* @__PURE__ */ new Date()).toISOString()
}, tl = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M19.503 0H4.496A4.496 4.496 0 000 4.496v15.007A4.496 4.496 0 004.496 24h15.007A4.496 4.496 0 0024 19.503V4.496A4.496 4.496 0 0019.503 0z\" fill=\"#fff\"></path><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"url(#folio-react-codex-gradient)\"></path><defs><linearGradient gradientUnits=\"userSpaceOnUse\" id=\"folio-react-codex-gradient\" x1=\"12\" x2=\"12\" y1=\"3\" y2=\"21\"><stop stop-color=\"#B1A7FF\"></stop><stop offset=\".5\" stop-color=\"#7A9DFF\"></stop><stop offset=\"1\" stop-color=\"#3941FF\"></stop></linearGradient></defs></svg>", nl = "<svg viewBox=\"0 0 24 24\" aria-hidden=\"true\" xmlns=\"http://www.w3.org/2000/svg\"><path d=\"M9.064 3.344a4.578 4.578 0 012.285-.312c1 .115 1.891.54 2.673 1.275.01.01.024.017.037.021a.09.09 0 00.043 0 4.55 4.55 0 013.046.275l.047.022.116.057a4.581 4.581 0 012.188 2.399c.209.51.313 1.041.315 1.595a4.24 4.24 0 01-.134 1.223.123.123 0 00.03.115c.594.607.988 1.33 1.183 2.17.289 1.425-.007 2.71-.887 3.854l-.136.166a4.548 4.548 0 01-2.201 1.388.123.123 0 00-.081.076c-.191.551-.383 1.023-.74 1.494-.9 1.187-2.222 1.846-3.711 1.838-1.187-.006-2.239-.44-3.157-1.302a.107.107 0 00-.105-.024c-.388.125-.78.143-1.204.138a4.441 4.441 0 01-1.945-.466 4.544 4.544 0 01-1.61-1.335c-.152-.202-.303-.392-.414-.617a5.81 5.81 0 01-.37-.961 4.582 4.582 0 01-.014-2.298.124.124 0 00.006-.056.085.085 0 00-.027-.048 4.467 4.467 0 01-1.034-1.651 3.896 3.896 0 01-.251-1.192 5.189 5.189 0 01.141-1.6c.337-1.112.982-1.985 1.933-2.618.212-.141.413-.251.601-.33.215-.089.43-.164.646-.227a.098.098 0 00.065-.066 4.51 4.51 0 01.829-1.615 4.535 4.535 0 011.837-1.388zm3.482 10.565a.637.637 0 000 1.272h3.636a.637.637 0 100-1.272h-3.636zM8.462 9.23a.637.637 0 00-1.106.631l1.272 2.224-1.266 2.136a.636.636 0 101.095.649l1.454-2.455a.636.636 0 00.005-.64L8.462 9.23z\" fill=\"currentColor\"/></svg>", rl = "M4.709 15.955l4.72-2.647.08-.23-.08-.128H9.2l-.79-.048-2.698-.073-2.339-.097-2.266-.122-.571-.121L0 11.784l.055-.352.48-.321.686.06 1.52.103 2.278.158 1.652.097 2.449.255h.389l.055-.157-.134-.098-.103-.097-2.358-1.596-2.552-1.688-1.336-.972-.724-.491-.364-.462-.158-1.008.656-.722.881.06.225.061.893.686 1.908 1.476 2.491 1.833.365.304.145-.103.019-.073-.164-.274-1.355-2.446-1.446-2.49-.644-1.032-.17-.619a2.97 2.97 0 01-.104-.729L6.283.134 6.696 0l.996.134.42.364.62 1.414 1.002 2.229 1.555 3.03.456.898.243.832.091.255h.158V9.01l.128-1.706.237-2.095.23-2.695.08-.76.376-.91.747-.492.584.28.48.685-.067.444-.286 1.851-.559 2.903-.364 1.942h.212l.243-.242.985-1.306 1.652-2.064.73-.82.85-.904.547-.431h1.033l.76 1.129-.34 1.166-1.064 1.347-.881 1.142-1.264 1.7-.79 1.36.073.11.188-.02 2.856-.606 1.543-.28 1.841-.315.833.388.091.395-.328.807-1.969.486-2.309.462-3.439.813-.042.03.049.061 1.549.146.662.036h1.622l3.02.225.79.522.474.638-.079.485-1.215.62-1.64-.389-3.829-.91-1.312-.329h-.182v.11l1.093 1.068 2.006 1.81 2.509 2.33.127.578-.322.455-.34-.049-2.205-1.657-.851-.747-1.926-1.62h-.128v.17l.444.649 2.345 3.521.122 1.08-.17.353-.608.213-.668-.122-1.374-1.925-1.415-2.167-1.143-1.943-.14.08-.674 7.254-.316.37-.729.28-.607-.461-.322-.747.322-1.476.389-1.924.315-1.53.286-1.9.17-.632-.012-.042-.14.018-1.434 1.967-2.18 2.945-1.726 1.845-.414.164-.717-.37.067-.662.401-.589 2.388-3.036 1.44-1.882.93-1.086-.006-.158h-.055L4.132 18.56l-1.13.146-.487-.456.061-.746.231-.243 1.908-1.312-.006.006z", il = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${rl}" fill="#D97757" fill-rule="nonzero"></path></svg>`, al = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${rl}" fill="currentColor" fill-rule="nonzero"></path></svg>`, ol = "M21.751 22.607c1.34 1.005 3.35.335 1.508-1.508C17.73 15.74 18.904 1 12.037 1 5.17 1 6.342 15.74.815 21.1c-2.01 2.009.167 2.511 1.507 1.506 5.192-3.517 4.857-9.714 9.715-9.714 4.857 0 4.522 6.197 9.714 9.715z", sl = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${ol}" fill="url(#folio-react-antigravity-gradient)"></path><defs><linearGradient id="folio-react-antigravity-gradient" x1="5" x2="19" y1="22" y2="2" gradientUnits="userSpaceOnUse"><stop stop-color="#3186FF"></stop><stop offset=".42" stop-color="#34A853"></stop><stop offset=".72" stop-color="#FBBC04"></stop><stop offset="1" stop-color="#EA4335"></stop></linearGradient></defs></svg>`, cl = `<svg viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"><path d="${ol}" fill="currentColor"></path></svg>`, ll = "<svg viewBox=\"0 0 24 24\" fill=\"currentColor\" aria-hidden=\"true\"><path d=\"M9 3c.4 3.9 3.1 6.6 7 7-3.9.4-6.6 3.1-7 7-.4-3.9-3.1-6.6-7-7 3.9-.4 6.6-3.1 7-7z\"/><path d=\"M17.8 13c.25 2.4 1.85 4 4.2 4.25-2.35.25-3.95 1.85-4.2 4.25-.25-2.4-1.85-4-4.2-4.25 2.35-.25 3.95-1.85 4.2-4.25z\" opacity=\".7\"/></svg>", ul = {
	codex: {
		label: "Codex",
		color: "#3941ff",
		logo: tl,
...
function gl(e) {
	if (!e) return {};
	let t = {};
	for (let n of hl) Object.prototype.hasOwnProperty.call(e, n) && (t[n] = e[n]);
	return t;
}
function _l(e) {
	if (!e) return {};
...
function Sl(e) {
	return e?.provider && $c.has(e.provider) ? e.provider : e?.selectedAdapter || "";
}
function Cl(e, t = "") {
	let n = t && $c.has(t) ? t : Sl(e);
	return e?.adapters?.find((e) => e.id === n) || null;
}
function wl(e, t = "") {
	return ul[t && $c.has(t) ? t : Sl(e)] || ul.default;
}
function Tl(e) {
	return e?.modelChoices || [];
}
...
function Dl({ surface: e, open: t, onOpen: n, onClose: r }) {
	let [i, a] = (0, l.useState)(null), [o, s] = (0, l.useState)(null), [c, u] = (0, l.useState)([el]), [d, f] = (0, l.useState)(!1), p = Qc(el), m = qc(p.scope || void 0), [h, g] = (0, l.useState)(""), [_, v] = (0, l.useState)(""), [y, b] = (0, l.useState)(""), [x, S] = (0, l.useState)("medium"), [C, w] = (0, l.useState)(!1), T = (0, l.useRef)(null), E = (0, l.useRef)(null), [D, O] = (0, l.useState)(!1), [k, A] = (0, l.useState)(""), j = (0, l.useRef)(null), M = (0, l.useRef)({
		ownerSurface: e,
		patch: {}
	...
	let P = (0, l.useCallback)((e, t = !1, n = "") => {
		...
		a(e), v((e) => {
			let n = El(r);
			return t && Tl(r).some((t) => t.value === e) ? e : n;
		});
	}, []), F = (0, l.useCallback)((e) => {
		b(e), v(El(Cl(i, e)));
		...
		try {
			let t = e?.provider && $c.has(e.provider) ? e.provider : "", n = t ? `?adapter=${encodeURIComponent(t)}` : "";
	...
	let R = Cl(i, y), z = wl(i, y), H = Sl(i), U = !!y && y !== H, ee = Tl(R), te = [
		...
		if (!r || D) return;
		M.current = yl(M.current, e);
		let i = xl(window.FolioAgent?.currentContext, M.current, e, n), a = dl(), o = Date.now(), s = new Date(o).toISOString(), c = R?.label || z.label, l = _ || R?.model || "model";
		u((e) => [
			...e,
			{
				id: dl(),
							...
							children: [
								e.role === "assistant" && /* @__PURE__ */ (0, K.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, K.jsx)("time", { children: fl(e.createdAt) })
									]
								}),
...
var Ol = "자료 위치를 옮겼습니다. 서버를 재시작하기 전까지는 RSS 수집과 보관 기간 정리를 실행하지 않습니다 — 지금 수집하면 새 자료가 옛 폴더와 새 폴더로 갈립니다.", kl = {
	start: "",
	end: "",
	source: "",
	market: "",
...
function Fl(e) {
	let t = [
		...
		e.language ? Ml[e.language] || e.language : ""
	].filter(Boolean);
	return t.length ? t.join(" · ") : "전체 RSS 피드";
}
function Z(e, t) {
	let n = new URLSearchParams({
		offset: String((Math.max(1, e) - 1) * Al),
		limit: String(Al)
	});
...
async function Il(e) {
	let t = e;
	for (; I(t.status);) await Nl(1e3), t = await B(`/api/jobs/${encodeURIComponent(t.id)}`);
...
function zl() {
	let { isSelected: e } = _n(), t = dn("rss"), [n, r] = (0, l.useState)(null), [i, a] = (0, l.useState)(null), [o, s] = (0, l.useState)(1), [c, u] = (0, l.useState)(kl), [d, f] = (0, l.useState)(kl), [p, m] = (0, l.useState)(""), [h, g] = (0, l.useState)(!1), [_, v] = (0, l.useState)(!1), [y, b] = (0, l.useState)(!1), [x, S] = (0, l.useState)(""), [C, w] = (0, l.useState)(""), [T, E] = (0, l.useState)(!1), D = i?.items || [], O = i?.total ?? D.length, k = Math.max(1, Math.ceil(O / Al)), A = (0, l.useMemo)(() => i?.sources || [], [i?.sources]), j = (0, l.useMemo)(() => i?.languages || [], [i?.languages]), M = (0, l.useCallback)(async (e = o, t = c) => {
		g(!0), S("");
		try {
			let n = await B(`/api/rss/items?${Z(e, t).toString()}`);
	...
	async function R() {
		...
		try {
			let e = await Il(await V("/api/rssarchive/import", {}));
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("strong", { children: T ? `"${p.trim()}" 검색 결과` : Fl(c) }), /* @__PURE__ */ (0, K.jsx)("span", { children: ee })]
			}),
			...
			/* @__PURE__ */ (0, K.jsx)("section", {
				...
				children: D.length ? D.map((e, t) => {
					let n = Ll(e, t), r = String(e.description || "").trim(), i = Q(e);
					return /* @__PURE__ */ (0, K.jsxs)("article", {
							...
							children: [
								...
								/* @__PURE__ */ (0, K.jsxs)("div", {
									...
									children: [
										...
										/* @__PURE__ */ (0, K.jsx)("span", { children: Pl(e) })
									]
								}),
...
function Vl(e) {
	return e.bridgeSupported === !1 ? "지원 안 됨" : e.installed ? Bl(e) ? "사용 가능" : "로그인 필요" : "미설치";
}
function Hl(e) {
	return e.bridgeSupported === !1 ? "warn" : Bl(e) ? "ready" : e.installed ? "warn" : "";
}
function Ul(e) {
...
var Kl = 62e4;
function ql({ adapters: e, onSettings: t, disabled: n = !1 }) {
...
var Jl = "folio.homePreference.v1", Yl = "folio.agentCharacter.v1", Xl = "folio.motionPreference.v1", Zl = "folio:ui-preferences-updated", Ql = {
	home: {
		mode: "home",
		choiceSeen: !0
	},
...
function tu() {
	let e = eu($l(Jl)), t = eu($l(Yl)), n = $l(Xl);
	return {
		home: {
...
function ru(e) {
	typeof window > "u" || window.dispatchEvent(new CustomEvent(Zl, { detail: e }));
}
function iu(e) {
	return nu(Jl, e.home), nu(Yl, e.character), nu(Xl, e.motion), ru(e), e;
}
function au() {
	if (typeof window < "u") try {
		window.localStorage.removeItem(Jl), window.localStorage.removeItem(Yl), window.localStorage.removeItem(Xl);
	} catch {}
	let e = structuredClone(Ql);
	return ru(e), e;
}
function ou(e = tu()) {
	return "home";
...
function su() {
	let [e, t] = (0, l.useState)(() => tu());
	(0, l.useEffect)(() => {
		let e = (e) => {
			let n = e.detail;
			t(n || tu());
		}, n = () => t(tu());
		return window.addEventListener(Zl, e), window.addEventListener("storage", n), () => {
			window.removeEventListener(Zl, e), window.removeEventListener("storage", n);
		};
	}, []);
	function n(e) {
		t(e), iu(e);
...
function uu() {
	return {
		preference: cu(window.FolioTheme?.preference) ? window.FolioTheme.preference : "system",
		resolved: lu(window.FolioTheme?.resolved) ? window.FolioTheme.resolved : window.matchMedia("(prefers-color-scheme: dark)").matches ? "dark" : "light"
	};
}
function du() {
	...
	return (0, l.useEffect)(() => {
		let e = (e) => {
			let n = e?.detail;
			if (n && cu(n.preference) && lu(n.resolved)) {
				t(n);
				return;
			}
			t(uu());
...
function xu({ checked: e, onChange: t, label: n, ariaLabel: r, compact: i = !1, disabled: a = !1, title: o }) {
...
function Su(e) {
	return {
		rss: {
			...
			retentionDays: e.rss?.retentionDays ?? Pu
		},
		marketMemory: {
		...
		briefingSchedules: (e.briefingSchedules || []).slice(0, Cu).map((e) => ({
			id: e.id,
			enabled: !!e.enabled,
			time: e.time || "08:00",
			markets: [...e.markets || []],
...
], Ou = Object.fromEntries(Du.flatMap((e) => [[e.id, e.label], [e.id.toUpperCase(), e.label]])), ku = [
	{
		label: "아침",
		time: "08:00",
		markets: ["us", "europe"],
...
var Ru = 5e7;
function zu(e) {
	return (e || 0) >= Ru ? `검색 색인에서 약 ${Lu(e)}를 돌려받습니다. 그동안 검색이 잠시 멈춥니다.` : "정리 후 검색 색인을 다시 만들고 파일 크기를 줄입니다. 몇 분 걸릴 수 있습니다.";
}
function Bu({ preview: e, days: t }) {
...
function Hu({ schedules: e, watched: t, runsById: n, onChange: r }) {
	let i = (t, n) => r(e.map((e) => e.id === t ? {
		...e,
		...n
	} : e)), a = (e, t) => {
		let n = e.markets.includes(t) ? e.markets.filter((e) => e !== t) : Du.map((e) => e.id).filter((n) => n === t || e.markets.includes(n));
		i(e.id, {
			markets: n,
			...n.length ? {} : { enabled: !1 }
		});
	}, o = (e, t) => {
		let n = Eu(e), r = n.includes(t) ? n.filter((e) => e !== t) : Tu.filter((e) => e === t || n.includes(e));
		i(e.id, {
			days: r,
			...r.length ? {} : { enabled: !1 }
		});
		...
		children: [
			e.map((s) => {
				...
				return /* @__PURE__ */ (0, K.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, K.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, K.jsx)("select", {
									...
									children: Object.entries(Au).map(([e, t]) => /* @__PURE__ */ (0, K.jsx)("option", {
										value: e,
										children: t
									}, e))
								}),
								ju(s) === "daily" && /* @__PURE__ */ (0, K.jsx)("select", {
									"aria-label": "브리핑 유형",
									value: s.briefingType,
									onChange: (e) => i(s.id, { briefingType: e.currentTarget.value }),
									children: Object.entries(Wu).map(([e, t]) => /* @__PURE__ */ (0, K.jsx)("option", {
										value: e,
										children: t
									}, e))
								}),
								/* @__PURE__ */ (0, K.jsx)(xu, {
									...
									disabled: !s.markets.length || !Eu(s).length,
									title: s.markets.length ? Eu(s).length ? void 0 : "요일을 하나 이상 골라야 켤 수 있습니다." : "시장을 하나 이상 골라야 켤 수 있습니다.",
									compact: !0
								}),
								/* @__PURE__ */ (0, K.jsx)("button", {
						...
						ju(s) === "weekly" && /* @__PURE__ */ (0, K.jsx)("p", {
							className: "settings-hint",
						...
						/* @__PURE__ */ (0, K.jsx)("div", {
							...
							children: wu.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
								type: "button",
								"aria-pressed": Eu(s).includes(e.id),
								onClick: () => o(s, e.id),
								children: e.label
							}, e.id))
						}),
						/* @__PURE__ */ (0, K.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "브리핑 전에 RSS 수집과 시장 메모리 갱신" }), /* @__PURE__ */ (0, K.jsx)(xu, {
						...
						c.length > 0 && /* @__PURE__ */ (0, K.jsxs)("p", {
							...
							children: [
								"관심 시장에서 꺼둔 ",
								c.map((e) => Du.find((t) => t.id === e)?.label || e).join(" · "),
								"은(는) 빼고 생성합니다."
							]
						}),
						/* @__PURE__ */ (0, K.jsx)(Uu, { run: n[s.id] })
					]
				}, s.id);
			}),
			!e.length && c.length > 0 && /* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("p", {
					...
					children: [
						...
						e.time,
						" — ",
						e.markets.map((e) => Du.find((t) => t.id === e)?.label).join(" · "),
			...
			/* @__PURE__ */ (0, K.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("button", {
					className: "btn",
					type: "button",
					disabled: e.length >= Cu,
					onClick: () => s(t.length ? [...t] : Du.map((e) => e.id), "08:00"),
					children: "예약 추가"
				}), e.length >= Cu && /* @__PURE__ */ (0, K.jsxs)("span", {
					className: "settings-hint",
					children: [
						"최대 ",
						Cu,
...
function Ju() {
	let e = du(), t = su(), [n, r] = (0, l.useState)("admin"), [i, a] = (0, l.useState)(null), [o, s] = (0, l.useState)(null), [c, u] = (0, l.useState)({}), [d, f] = (0, l.useState)({}), [p, m] = (0, l.useState)([]), [h, g] = (0, l.useState)(null), [_, v] = (0, l.useState)(Du.map((e) => e.id)), [y, b] = (0, l.useState)({}), [x, S] = (0, l.useState)(null), [C, w] = (0, l.useState)("openai"), [T, E] = (0, l.useState)(""), [D, O] = (0, l.useState)(""), [k, A] = (0, l.useState)(!0), [j, M] = (0, l.useState)("cli"), [N, P] = (0, l.useState)("codex"), [F, I] = (0, l.useState)(""), [L, R] = (0, l.useState)({
		fred: "",
		bok: "",
		dart: ""
	}), [z, H] = (0, l.useState)({
		...
		text: t,
		tone: "error"
	}), []), [oe, se] = (0, l.useState)(""), ce = i?.llm?.providers || {}, le = ce[C] || {}, ue = _u[C], de = le.modelChoices || [], fe = o?.adapters || [], pe = (fe.find((e) => e.id === N) || fe[0])?.modelChoices || [], me = [
		"codex",
		"claude",
		"antigravity"
	].includes(o?.provider || "") ? String(o?.provider) : String(o?.selectedAdapter || fe[0]?.id || "codex"), he = fe.find((e) => e.id === me) || fe[0], ge = k !== (i?.agent?.enabled !== !1) || j !== (i?.agent?.mode === "api" ? "api" : "cli") || N !== me || F !== yu(he?.model, he?.modelChoices) || C !== vu(i?.llm?.provider) || D !== yu(le.model, le.modelChoices) || T.trim() !== "", _e = !!(L.fred.trim() || L.bok.trim() || L.dart.trim()), ve = !!z.token.trim() || z.dbId.trim() !== String(i?.notion?.dbId || "").trim(), ye = U.trim() !== String(y.vaultPath || "").trim(), be = JSON.stringify(Su(c)) !== JSON.stringify(Su(d)), xe = (0, l.useMemo)(() => {
		let e = {};
		for (let t of p) {
			let n = String(t.kind || "");
			n && !e[n] && (e[n] = t);
		...
		try {
			...
			I(_.some((e) => e.value === g?.model) ? String(g?.model || "") : _[0]?.value || ""), window.dispatchEvent(new CustomEvent("folio:agent-settings-updated", { detail: n })), u(Su(r)), f(Su(r)), b(i), ee(i.vaultPath || ""), J("settings", {
				surface: "settings",
				viewId: "settings",
				reportKind: "",
				reportId: ""
	...
	let Ee = Number(c.rss?.retentionDays ?? Pu);
	(0, l.useEffect)(() => {
		if (Ee <= 0) return;
		let e = !0;
	...
	async function Ne() {
		...
		try {
			let e = await V("/api/automation/settings", Su(c));
			u(Su(e)), f(Su(e)), ie("automation", "자동화 설정을 저장했습니다.");
		} catch (e) {
	...
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, K.jsx)("div", {
				...
				role: "group",
				"aria-label": "설정 하위 탭",
				children: hu.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
					type: "button",
					"aria-pressed": n === e.id,
					onClick: () => r(e.id),
					children: e.label
								...
								children: j === "cli" ? /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [/* @__PURE__ */ (0, K.jsxs)("div", {
									...
									/* @__PURE__ */ (0, K.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "API 제공자" }), /* @__PURE__ */ (0, K.jsxs)("select", {
											value: C,
											onChange: (e) => w(vu(e.currentTarget.value)),
											children: [
												/* @__PURE__ */ (0, K.jsx)("option", {
													value: "openai",
													children: "GPT / OpenAI"
										...
										children: Pe.map(({ providerId: e, row: t, label: n, className: r, detail: i, checkedAt: a }) => /* @__PURE__ */ (0, K.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, K.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, K.jsxs)("div", {
													className: "cli-provider-head",
													children: [
														/* @__PURE__ */ (0, K.jsx)("strong", { children: t.label || _u[e].name }),
														/* @__PURE__ */ (0, K.jsx)("span", {
								...
								children: [
									/* @__PURE__ */ (0, K.jsxs)("section", {
										...
										children: [
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "기사 전문 저장 (무료 공개 본문만, 로컬 보관용)" }), /* @__PURE__ */ (0, K.jsx)(xu, {
													ariaLabel: "기사 전문 저장",
											...
											/* @__PURE__ */ (0, K.jsxs)("label", {
												...
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "보관 기간" }), /* @__PURE__ */ (0, K.jsx)("select", {
													...
													children: Fu.map((e) => /* @__PURE__ */ (0, K.jsx)("option", {
														value: e.value,
														children: e.label
													}, e.value))
												})]
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												...
												children: [/* @__PURE__ */ (0, K.jsx)("button", {
													...
													className: "settings-hint",
													children: zu(h?.reclaimableBytes)
												})]
											}),
											/* @__PURE__ */ (0, K.jsx)(Uu, { run: xe.rss })
										]
									}),
									/* @__PURE__ */ (0, K.jsxs)("section", {
										className: "automation-card",
										children: [
											...
											/* @__PURE__ */ (0, K.jsxs)("div", {
												className: "automation-inline-switch",
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "RSS 수집 직후에도 정리" }), /* @__PURE__ */ (0, K.jsx)(xu, {
											...
											/* @__PURE__ */ (0, K.jsx)(Uu, { run: xe.marketMemory })
										]
									}),
									/* @__PURE__ */ (0, K.jsxs)("section", {
										className: "automation-card",
										children: [
											...
											/* @__PURE__ */ (0, K.jsxs)("label", {
												...
												children: [/* @__PURE__ */ (0, K.jsx)("span", { children: "시각을 놓쳤을 때" }), /* @__PURE__ */ (0, K.jsx)("select", {
													...
													children: Nu.map((e) => /* @__PURE__ */ (0, K.jsx)("option", {
														value: e.value,
														children: e.label
													}, e.value))
												})]
...
function ed(e, t = /* @__PURE__ */ new Date()) {
	...
	for (let r of e || []) {
		...
		let e = String(r.startsAt || ""), i = Zu(e, t);
...
async function nd(e, t = /* @__PURE__ */ new Date()) {
	...
	try {
		return ed((await B(`/api/market-calendar?${i}`)).events || [], t);
	} catch {
		return {};
	}
}
...
function ad(e) {
	return e.companyName || e.name || e.item || id(e);
}
function od(e, t = "") {
...
var dd = /^(?:co|inc|ltd|corp|llc|plc|ag|nv|sa|se|kk|gmbh|s\.?a\.?s|co\.?,?\s*ltd)\.?$/i;
function fd(e, t) {
	let n = String(e || "").trim();
	return n ? t ? [n] : n.split(/[,;\n]/).map((e) => e.trim()).filter(Boolean).filter((e) => !dd.test(e)) : [];
}
function pd(e) {
...
function gd() {
	let { resolved: e } = du(), [t, n] = (0, l.useState)([]), [r, i] = (0, l.useState)([]), [a, o] = (0, l.useState)(""), [s, c] = (0, l.useState)(() => md()), [u, d] = (0, l.useState)(null), [f, p] = (0, l.useState)(!1), [m, h] = (0, l.useState)(!1), [g, _] = (0, l.useState)(!1), [v, y] = (0, l.useState)(""), [b, x] = (0, l.useState)(""), S = (0, l.useRef)(null), [C, w] = (0, l.useState)({}), T = (0, l.useCallback)(async (e) => {
		if (!e.length) {
			i([]);
			return;
		}
		let t = await B("/api/watchlist/overview"), n = Array.isArray(t.items) ? t.items : [];
		i(n), nd(n.map((e) => e.ticker || "").filter(Boolean)).then(w);
	}, []), E = (0, l.useCallback)(async () => {
		p(!0), y("");
		try {
			let e = await B("/api/watchlist"), t = rd(Array.isArray(e) ? e : []);
			n(t), await T(t), J("watchlist", {
				surface: "watchlist",
				viewId: "watchlist",
				reportKind: "",
				reportId: ""
	...
	async function D(e, t) {
		_(!0), y("");
		try {
			let r = await V("/api/watchlist", { items: e }), i = rd(Array.isArray(r) ? r : []);
			n(i), await T(i), t && x(t);
		} catch (e) {
	...
	let { resolution: O, pending: k, picked: A, pick: j } = na(a, { preferHome: !0 }), M = !!A || O?.status === "confident", N = a.trim() ? A ? `${A.name}로 추가합니다.` : k ? "확인 중…" : O?.status === "confident" && O.match ? `${O.match.name}로 추가합니다.` : O?.status === "ambiguous" && O.candidates.some((e) => e.strong) ? "여러 기업이 맞습니다. 고르거나, 이대로 주제 키워드로 추가합니다." : "주제 키워드로 추가합니다." : "종목은 이름이나 티커로, 관심 주제는 그대로 적으면 됩니다.";
	async function P(e) {
		try {
	...
	async function F() {
		...
		o(""), n.length !== t.length && await D(n, "워치리스트에 추가했습니다.");
	}
	async function I(e) {
		await D(t.filter((t) => t !== e), "워치리스트에서 삭제했습니다."), s === e && pd();
	}
	let L = (0, l.useMemo)(() => cd(u?.news || []), [u]), R = od(u, s), z = H(r.find((e) => (e.item || ad(e)) === s) || null) || C[String(u?.company?.ticker || "").toUpperCase()];
	function H(e) {
	...
	return s ? /* @__PURE__ */ (0, K.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, K.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, K.jsxs)("nav", {
				...
				children: [
					...
					z?.startsAt && /* @__PURE__ */ (0, K.jsxs)("div", {
						className: "watchlist-detail-earnings",
						children: [/* @__PURE__ */ (0, K.jsx)("h3", { children: "다음 실적 일정" }), /* @__PURE__ */ (0, K.jsxs)("p", {
							className: "watchlist-detail-earnings-line",
							children: [
								/* @__PURE__ */ (0, K.jsx)("strong", { children: $u(z.startsAt) }),
								Qu(z.startsAt) && /* @__PURE__ */ (0, K.jsx)("span", {
									className: "chip watchlist-earnings-chip",
									"data-estimated": Xu(z) ? "true" : void 0,
									children: Qu(z.startsAt)
								}),
								/* @__PURE__ */ (0, K.jsx)("span", {
									className: "section-subtitle",
									children: Xu(z) ? "제3자 예정치입니다. 회사 IR 공지로 다시 확인하세요." : "공식 일정입니다."
								})
							]
						})]
					}),
					/* @__PURE__ */ (0, K.jsxs)("div", {
						...
						}) : L.length ? /* @__PURE__ */ (0, K.jsx)("div", {
							className: "watchlist-detail-news-list",
							children: L.map((e, t) => /* @__PURE__ */ (0, K.jsxs)("article", {
		...
		children: [
				...
				children: [
					...
					/* @__PURE__ */ (0, K.jsxs)("label", {
						...
						children: [
							...
							O?.status === "ambiguous" && O.candidates.some((e) => e.strong) && !A && /* @__PURE__ */ (0, K.jsx)("div", {
								className: "ticker-suggest",
								role: "listbox",
								"aria-label": "후보 기업",
								children: O.candidates.map((e) => /* @__PURE__ */ (0, K.jsxs)("button", {
									type: "button",
									role: "option",
									"aria-selected": !1,
									onClick: () => {
			...
			/* @__PURE__ */ (0, K.jsx)("p", {
				...
				"data-status": a.trim() ? A ? "picked" : O?.status || "idle" : "idle",
				children: N
			}),
			v && /* @__PURE__ */ (0, K.jsx)("p", {
				className: "react-dashboard-error",
						...
						children: [
							...
							/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, K.jsx)("strong", {
									...
									children: id(e)
								}), /* @__PURE__ */ (0, K.jsx)("h3", { children: ad(e) })]
							}),
							/* @__PURE__ */ (0, K.jsxs)("div", {
								...
								children: [
									...
									(() => {
										...
										return n ? /* @__PURE__ */ (0, K.jsxs)("span", {
											className: "chip watchlist-earnings-chip",
											"data-estimated": Xu(t) ? "true" : void 0,
											title: `실적 ${$u(t.startsAt)}${Xu(t) ? " (예정치)" : ""}`,
											children: [
												"실적 ",
												n,
												Xu(t) ? "*" : ""
...
function yd() {
	let e = du(), [t, n] = (0, l.useState)(!1), r = (0, l.useRef)(null), i = (0, l.useRef)(null), a = (0, l.useRef)([]), o = e.preference === "system" ? `시스템 (${vd[e.resolved]})` : vd[e.preference];
	(0, l.useEffect)(() => {
		if (!t) return;
		let e = (e) => {
		...
		if (!t) return;
		let n = Math.max(0, _d.indexOf(e.preference));
		a.current[n]?.focus();
	}, [t, e.preference]);
	let s = (e, t) => {
		let n = (e + t + _d.length) % _d.length;
		a.current[n]?.focus();
	};
	return /* @__PURE__ */ (0, K.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, K.jsx)("button", {
			...
			"data-tooltip-pos": "bottom",
			onClick: () => n((e) => !e),
			children: /* @__PURE__ */ (0, K.jsx)($, { preference: e.preference })
		}), t && /* @__PURE__ */ (0, K.jsx)("div", {
			className: "theme-menu-list",
			role: "menu",
			"aria-label": "화면 테마",
			children: _d.map((t, r) => /* @__PURE__ */ (0, K.jsxs)("button", {
				type: "button",
				role: "menuitemradio",
				...
				children: [/* @__PURE__ */ (0, K.jsx)($, { preference: t }), vd[t]]
			}, t))
		})]
	});
}
...
function Sd() {
	...
	})), u = e?.provider && bd.includes(e.provider) ? e.provider : "", d = c.find((e) => e.id === u)?.row?.label || "선택 안 됨";
	async function f(n) {
		a(!0);
		try {
...
function Ad() {
	let { hash: e, routeId: t } = Od(), n = Yi(t), r = ou(su().preferences), [i, a] = (0, l.useState)(() => localStorage.getItem("folio.react.navCollapsed") === "1"), o = (0, l.useRef)(!1), [s, c] = (0, l.useState)(() => {
		let e = localStorage.getItem("folio.react.agentClosed"), t = e === null || e !== "1";
		return t && Ed() ? (o.current = !0, !1) : t;
	}), [u, d] = (0, l.useState)(() => /* @__PURE__ */ new Set([t])), [f, p] = (0, l.useState)(() => ({ [t]: Dd() })), [m, h] = (0, l.useState)(""), [g, _] = (0, l.useState)(!1), v = (0, l.useRef)(null), y = (0, l.useRef)(t), b = (0, l.useRef)(!1), x = (0, l.useRef)({}), S = n.id !== "home", C = S && s ? " is-agent-open" : " is-agent-closed";
	(0, l.useEffect)(() => {
		et(n.id, {
			surface: `react_${n.id}`,
			viewId: n.id
		...
		let e = window.matchMedia(Td), t = (e) => {
	...
	function E(e) {
		let t = Yi(e);
		return t.id === "home" ? /* @__PURE__ */ (0, K.jsx)(ln, {}) : t.id === "dashboard" ? /* @__PURE__ */ (0, K.jsx)(Io, {}) : t.id === "briefing" ? /* @__PURE__ */ (0, K.jsx)(Ui, {}) : t.id === "rss" ? /* @__PURE__ */ (0, K.jsx)(zl, {}) : t.id === "market-memory" ? /* @__PURE__ */ (0, K.jsx)(vc, {}) : t.id === "analysis" ? /* @__PURE__ */ (0, K.jsx)(X, {}) : t.id === "deep-research" ? /* @__PURE__ */ (0, K.jsx)(Ns, {}) : t.id === "watchlist" ? /* @__PURE__ */ (0, K.jsx)(gd, {}) : t.id === "portfolio" ? /* @__PURE__ */ (0, K.jsx)(Gc, {}) : t.id === "settings" ? /* @__PURE__ */ (0, K.jsx)(Ju, {}) : null;
	}
	return /* @__PURE__ */ (0, K.jsxs)("div", {
			...
			/* @__PURE__ */ (0, K.jsxs)("aside", {
				...
				children: [/* @__PURE__ */ (0, K.jsx)("button", {
					...
					children: [/* @__PURE__ */ (0, K.jsx)("div", {
						...
						children: "Navigate"
					}), Cd.map((e) => /* @__PURE__ */ (0, K.jsxs)("section", {
...
function Ld(e) {
	if (!e) return {
		top: Math.max(Pd, window.innerHeight / 2 - 120),
		left: Math.max(Pd, (window.innerWidth - Md) / 2)
	};
	let t = window.innerWidth - (e.left + e.width) - Nd >= 352 ? e.left + e.width + Nd : Math.min(Math.max(Pd, e.left), window.innerWidth - Md - Pd);
	return {
		top: Math.min(Math.max(Pd, e.top - 8), Math.max(Pd, window.innerHeight - 260)),
		left: t
	};
}
function Rd({ onDone: e }) {
	let [t, n] = (0, l.useState)(0), [r, i] = (0, l.useState)(null), a = (0, l.useRef)(null), o = (0, l.useRef)(null), s = jd[Math.min(t, jd.length - 1)];
	(0, l.useEffect)(() => {
		let e = Ji(s.route);
...
function Kd({ onFinish: e }) {
	let t = du(), [n, r] = (0, l.useState)("welcome"), [i, a] = (0, l.useState)(""), [o, s] = (0, l.useState)(""), c = (0, l.useCallback)((e) => {
		s(""), r(e);
	...
	}, R = zd.indexOf(n), z = Vd.find((e) => e.id === m);
	return /* @__PURE__ */ (0, K.jsx)("div", {
				...
				/* @__PURE__ */ (0, K.jsxs)("section", {
					...
					children: [
						/* @__PURE__ */ (0, K.jsxs)("p", {
							...
							children: [/* @__PURE__ */ (0, K.jsx)(Gd, { step: n }), Wd[n]]
						}),
						...
						n === "engine" && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
							...
							u === "api" && /* @__PURE__ */ (0, K.jsxs)(K.Fragment, { children: [
								...
								/* @__PURE__ */ (0, K.jsx)("div", {
									...
									role: "group",
									"aria-label": "제공사",
									children: Vd.map((e) => /* @__PURE__ */ (0, K.jsx)("button", {
										type: "button",
										"aria-pressed": m === e.id,
										onClick: () => h(e.id),
										children: e.label
...
function qd() {
	...
	return (0, l.useEffect)(() => {
		...
		/* @__PURE__ */ (0, K.jsx)(Ad, {}),
		e && /* @__PURE__ */ (0, K.jsx)(Kd, { onFinish: (e) => {
			t(!1), r(e);
		} }),
...
//#endregion
//#region src/main.tsx
var Jd = { "market-state": () => /* @__PURE__ */ (0, K.jsx)($s, {}) };
function Yd() {
	document.querySelectorAll("[data-react-island]").forEach((e) => {
		let t = Jd[e.dataset.reactIsland || ""];
...
function Xd() {
	...
	return e ? e.dataset.reactMounted === "1" || (e.dataset.reactMounted = "1", (0, u.createRoot)(e).render(/* @__PURE__ */ (0, K.jsx)(l.StrictMode, { children: /* @__PURE__ */ (0, K.jsx)(qd, {}) })), !0) : !1;
}
function Zd() {
	Xd(), Yd();
}
