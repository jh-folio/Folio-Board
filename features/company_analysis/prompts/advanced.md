...
공통 내부 분석 방향에 따라 기업별 쟁점을 고르고 여러 섹션의 설명을 연결합니다. 질문 목록을 보여주지 않으며, 아래 숙련자용 설명 깊이는 유지합니다.
...
- `분석 범위:`로 시작하는 한 문단에 이 보고서가 근거로 쓴 자료, 다루는 것과 다루지 않는 것(자료가 없어 제외한 것)을 밝힙니다.
