...
PROMPT_REQUIRED_RULES = (
    ...
    "주도 기업 선정 기준",
    # 자국 상장 경계. 미국장에만 ADR 문장이 있고 나머지 세 시장에는 아무 경계가 없어,
    # 엔비디아 실적이 도쿄를 움직인 날 JP 브리핑이 "일본장을 주도한 기업 ① — 엔비디아
    # (NAS:NVDA)"를 올렸다(2026-08-28 실측). 재료가 해외라도 주도 기업 자리는 그 재료에
    # 반응한 자국 상장 종목의 것이다 — 상장돼 있지 않은 회사는 그 시장의 수급 주체가
    # 될 수 없다.
    "상장된 종목에서 고른다",
    "자료 사용 우선순위와 웹 검색 보완",
    "품질 기준을 먼저 만족시키며 작성하라",
